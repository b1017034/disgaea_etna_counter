...
if __name__ == '__main__':
    ...
    goal_title_label.grid(column=3, row=0)
    goal_common_only_label = tk.Label(root, text="コモン：13個")
    goal_common_only_label.grid(column=3, row=1)
    goal_common_and_rare_label = tk.Label(root, text="レア：6個、コモン：1個")
    goal_common_and_rare_label.grid(column=3, row=2)
